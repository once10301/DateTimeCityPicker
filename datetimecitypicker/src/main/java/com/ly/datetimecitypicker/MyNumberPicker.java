...
public class MyNumberPicker extends View {
    ...
    private static final int DEFAULT_TEXT_COLOR = Color.rgb(236, 111, 28);
    ...
    private void initPaint() {
        ...
        mDividerLinePaint.setStrokeWidth(1 * mDensity);
        ...
        for (int i = 0; i < mTextYAxisArray.length; i++) {
            if (mTextYAxisArray[i].mmIndex >= 0 && mTextYAxisArray[i].mmIndex <= mEndNumber - mStartNumber) {
                ...
                if (mTextArray != null) {
                    ...
                    int num = mNumberArray[mTextYAxisArray[i].mmIndex];
                    text = num < 10 ? "0" +num : num + "";
                }
                canvas.drawText(text, mWidth / 2, mTextYAxisArray[i].mmPos + mTextBounds.height() / 2, mTextPaint);
            }
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null == mHighLightRect) {
            ...
            Shader topShader = new LinearGradient(0, 0, 0, mHighLightRect.top, new int[]{mBackgroundColor & 0xDFFFFFFF, mBackgroundColor & 0xCFFFFFFF, mBackgroundColor & 0x00FFFFFF}, null, Shader.TileMode.CLAMP);

            Shader bottomShader = new LinearGradient(0, mHighLightRect.bottom, 0, mHeight, new int[]{mBackgroundColor & 0x00FFFFFF, mBackgroundColor & 0xCFFFFFFF, mBackgroundColor & 0xDFFFFFFF}, null, Shader.TileMode.CLAMP);
    ...
    public MyNumberPicker setStartNumber(int startNumber) {
    ...
    public MyNumberPicker setEndNumber(int endNumber) {
    ...
    public MyNumberPicker setCurrentNumber(int currentNumber) {
    ...
    public MyNumberPicker setRowNumber(int rowNumber) {
    ...
    public MyNumberPicker setTextColor(int color) {
        mTextColor = color;
        initPaint();
        invalidate();
        return this;
    ...
    public MyNumberPicker setTextSize(float textSize) {
        mTextSize = (int) (textSize *mDensity);
        init();
        invalidate();
        return this;
    }

    public MyNumberPicker setPadding(int padding) {
        mVerticalSpacing = (int) (padding *mDensity);
        init();
        invalidate();
        return this;
    }

    public MyNumberPicker setBackground(int color) {
    ...
    public interface OnScrollListener {
        ...
        public void onScrollStateChange(MyNumberPicker picker, int scrollState);
    }

    public MyNumberPicker setOnScrollListener(OnScrollListener l) {
        mOnScrollListener = l;
        return this;
    }

    public MyNumberPicker setOnValueChangeListener(OnValueChangeListener l) {
    ...
    public MyNumberPicker setSoundEffect(Sound sound) {
        mSound = sound;
        return this;
    }
    ...
    public MyNumberPicker setCustomTextArray(String[] textArray) {
